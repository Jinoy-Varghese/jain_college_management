...
if(!isset($_SESSION['u_id']) OR $_SESSION['role']!="placement_cell")
{
...
<div class='rounded-circle ml-md-2'><img src="<?php echo base_url('assets/image/jain_logo.png');?>"class="ml-n1 mt-n1 p-1" style='width:155px; height:60px;'></div>
</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo02">
      <ul class="navbar-nav my-2 my-lg-0">
        ...
        <li class="nav-item dropdown mr-4">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" style="border-top-color: coral;">
            <span class="dropdown-menu-arrow" ></span>
              <a class="dropdown-item" href="<?php echo site_url(); ?>Placement_cell/placement_cell_profile"><i class="fa fa-user mr-1"></i>My Profile</a>
