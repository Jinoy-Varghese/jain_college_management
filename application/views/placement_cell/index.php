...
axis.min = 0;
axis.max = <?php echo $this->db->like('user_status','1')->from('users')->where('role','student')->count_all_results(); ?>;
    ...
    <div class="row mt-5"> 
        ...
        <div class="text-right" style="opacity:0.8;"><i class=" fa fa-flask text-white"></i></div>
                <div style=" font-size:30px;opacity:0.9;" class=" text-white font-weight-bold number-animation1">
                    <?php echo $this->db->like('user_status','1')->from('users')->where('role','student')->count_all_results(); ?> </div>
                <div class="text-white font-weight-bold ">TOTAL STUDENTS</div>
        </div></div>
        ...
        <div class="text-right" style="opacity:0.8;"><i class=" far fa-check-circle text-white"></i></div>
                ...
                <div class="text-white font-weight-bold ">PLACED</div>
        </div></div>
        ...
        <div class="text-right" style="opacity:0.8;"><i class=" far fa-times-circle text-white"></i></div>
                ...
                <div class="text-white font-weight-bold ">UNPLACED</div>
        </div></div>
        ...
        <div class="text-right" style="opacity:0.8;"><i class=" far fa-list-alt text-white"></i></div>
                ...
                <div class="text-white font-weight-bold ">TOTAL OFFERED</div>
        </div></div>
    </div>
    <div class="row mt-5">        
