...
?>
      ...
      <td><a href="<?php echo 'https://nextjs-zegocloud-uikits2.vercel.app/?roomID='.md5($user_data->subject).md5($user_data->sem); ?>" class="btn border-primary col-12 custom-button">Join</a></td>
	  	</tr>
	<?php		
  $i++;
	}
